    ...
    cards: [
      {
        ...
        href: '/products/air-max-270-sneakers',
        position: 'top-left',
      },
      {
        title: 'Smart Watch',
        ...
        href: '/products/ultra-slim-smart-watch-series-8',
        position: 'top-right',
      },
      {
        ...
        href: '/products/noise-canceling-wireless-headphones',
